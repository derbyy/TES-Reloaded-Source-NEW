...
class SceneGraph : public NiNode {
public:
	float				GetFarPlaneDistance() { return ThisCallF(0x00B17D50, this); }
...
public:
	...
	const char*			name;			// 018 BSFixedString
...
public:
	...
	NiTMap<HWND, NiRenderTargetGroup*>	m_kOnscreenRenderTargetGroups;		// 634 NiTPointerMap<HWND, NiRenderTargetGroupPtr>
	...
	NiTMap<NiRenderedTexture*, void*>	m_kRenderedTextures;			// 660 NiTPointerMap<NiRenderedTexture*, NiDX9RenderedTextureData*>
	NiTMap<NiRenderedCubeMap*, void*>	m_kRenderedCubeMaps;			// 670 NiTPointerMap<NiRenderedCubeMap*, NiDX9RenderedCubeMapData*>
	UInt32								unk680;							// 680
	UInt32								unk684;							// 684
	UInt32								unk688;							// 688
	UInt32								unk68C;							// 68C
	...
	NiColorAlpha*						m_pkScreenTextureColors;		// 7D4
