...
public:
	...
	bool				IsThirdPersonView(bool CameraMode, bool FirstPersonView) { return isThirdPerson; }
	bool				IsVanityView() { return *(bool*)0x011E07B8; }
	TESRegion*			GetCurrentRegion() { return currentRegion; }
...
public:
	...
	void			ShowMessage(const char* Message) { bool (__cdecl* ShowUIMessage)(const char*, UInt32, UInt32, float) = (bool (__cdecl*)(const char*, UInt32, UInt32, float))0x0057ACC0; ShowUIMessage(Message, NULL, 1, 2.0f); }
	UInt8			GetMessageBoxButton() { UInt8 B = msgBoxButton; msgBoxButton = -1; return B; }
...
public:
	...
	TESRegion*			GetCurrentRegion() { return NULL; }
